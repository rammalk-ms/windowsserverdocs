...
## When you use Storage Spaces Direct with 3 nodes, do you get both performance and capacity tiers?

Yes, you  get both  performance and capacity tiers in a 2-node or 3-node Storage Spaces Direct configuration. However, you must make sure that you have atleast 2 different types of devices. You can choose from: NVME, SSD, and HDD.
 
## Refs file system provides real-time tiering with Storage Spaces Direct. Does REFS provides the same functionality with shared storage spaces in 2016?
...
Use 2 servers on each of the racks to get the virtual disk resiliency of a 3-way mirror. Remember that the rack configuration would work correctly only if you are providing the configuration to the OS in the manner the servers are placed on the rack.
